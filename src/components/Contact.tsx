...
export const Contact = () => {
  ...
  return (
    <section
      id='contact'
      ref={ref}
      className='min-h-screen py-xxl px-lg md:py-xxl md:px-lg sm:py-xl sm:px-md max-w-[800px] mx-auto flex flex-col justify-center items-center text-center'
    >
      <motion.p
      ...
      <footer className='mt-xxl pt-lg border-t border-accent/10 text-textSecondary text-sm'>
        <p>Desenvolvido por Você • 2024</p>
      </footer>
    </section>
  )
}
